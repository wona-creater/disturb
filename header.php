        ...
        <div class="row d-flex header-area">
          <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="index.php">
              <img src="assets/images/logo1.png" class="logo" style="width: 131px; height: auto;" alt="logo">
            </a>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbar-content">
              <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item ">
                  <a class="nav-link" data-bs-toggle="page" href="products.php">Products</a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" data-bs-toggle="page" href="services.php">Services</a>
                </li>
                <li class="nav-item">
              ...
              <div class="right-area header-action d-flex align-items-center">
                <a href="account/index" class="cmn-btn">Open Account</a>
              </div>
            </div>
          </nav>
        </div>
...
<body>
  ...
  <div class="boxed_wrapper ltr">
      ...
      <div class="header-lower">
        <div class="large-container">
          <div class="outer-box">
            <div class="">
              <!-- <div class="shape"></div> -->
              <figure class="logo"><a href="index.php"><img src="" alt=""></a></figure>
            </div>
            <div class="menu-area">
              ...
              <div class="menu-right-content ml_70">
                <a href="account/index" class="theme-btn btn-two mr_20">Login</a>
                <a href="account/index" class="theme-btn btn-one">Open Account</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="mobile-menu">
      ...
      <nav class="menu-box">
        <div class="nav-logo"><a href="index.php"><img src="" alt="" title=""></a></div>
