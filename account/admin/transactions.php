                                ...
                                <ul class="nk-tb-actions gx-1">
                                    <li class="nk-tb-action-hidden">
                                        <a href="edit_transfer?refNumber=<?php echo $refNumber;
                                                                            echo "&id=$id"; ?>" class="btn btn-trigger btn-icon" data-toggle="tooltip" data-placement="top" title="Edit">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <ul class="link-list-opt no-bdr">
                                                    <li><a href="edit_transfer?refNumber=<?php echo $refNumber;
                                                                                            echo "&id=$id"; ?>"><em class="icon ni ni-eye"></em><span>View Details</span></a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li>
